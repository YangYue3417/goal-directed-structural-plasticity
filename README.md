...
|:---:|:---|:---|
| **Bipedal Walker (coupled stepping)** | ![walker](assets/walker_tread.gif) | **Structurally coupled legs** (leg2 = anti-phase of leg1, 100% alternation, equal amplitude 0.92); hull ≥5.6 safety zone is the only hard constraint |
